...
import "package:melodi/theme/styles/sidebar_group_style.dart";
...
FSidebarStyle sidebarStyle({
  ...
  headerPadding: const .fromLTRB(8, 0, 8, 0),
  contentPadding: const .symmetric(vertical: 8, horizontal: 8),
  footerPadding: const .fromLTRB(8, 0, 8, 8),
);
